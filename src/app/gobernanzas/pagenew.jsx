          ...
          <div className="flex  justify-between items-center pb-[50px]">
            <div>
              <div className="max-w-[336px] pb-[24px]">
                <h4 className={styles.h3}>Plataformas activas actualmente</h4>
              </div>
              <div className="max-w-[336px] w-[90vw] ">
                <p className={styles.fontAlineadas}>
                Las plataformas de delegados son equipos que participan activamente de las discusiones y votaciones
                 de determinado protocolo, representando los intereses de determinada organización o comunidad
                </p>
              </div>
            </div>
