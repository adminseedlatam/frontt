    ...
    <div className={styles.hero}>
      ...
      <div className="max-w-[800px] min-h-screen px-[5vw] mt-10 hidden  md:flex">
        <div className=" 2xl:pt-[8.5rem] lg:pt-[3rem] md:pt-[8.5rem]" >
          <Image className="mb-[48px] mr-2 " height={227} src={logoIso} alt="Logo"></Image>
          <div className="flex">
            <Image className="py-4" alt="Logo" width={486.46} src={logoText}></Image>
          </div>
          <div>
            <p className={styles.tagline}>
              “Construyendo colectivamente el camino a la descentralización y la
              soberanía digital no permisionada”.
            </p>
            <Image className="py-4" alt="DeFi LATAM" width={206.1} src={formerly}></Image>
          </div>

          <div className="flex py-[2.23rem]">
            <div> <Link href="#Descubrenos">
              <button className={styles.hero_button1}>Descúbrenos</button>
            </Link></div>
           <div>
            <Link href="#Separte">
              <button className={styles.hero_button2}>Sé parte</button>
            </Link></div>
          </div>
          <div className="flex">
      ...
      <div className="max-w-[750px] min-h-screen px-[5vw]  flex md:hidden mt-10">
        <div>
          <Image className="mt-10 mr-2 " height={90.19} src={logoIso} alt="Logo"></Image>
          <div className="flex">
            <Image className="py-4" alt="Logo" width={215} src={logoText}></Image>
          </div>
          <div>
            ...
            <Image className="py-4" alt="DeFi LATAM" width={122.86} src={formerly}></Image>
          </div>
